...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # mask&re-sample parameters
        parser.add_argument('--use_mask', action='store_true')
        parser.add_argument('--use_dino', action='store_true')
        parser.add_argument('--bio_mask_dir', type=str, default='/home/ubuntu/dongjy/01.codes/13.BioStain/BioMask/MIST/ER/')
        parser.add_argument('--dino_mask_dir', type=str, default='/home/ubuntu/dongjy/01.codes/13.BioStain/dino-main/DINO-Attention/MIST/ER/trainA/attn-head-5/')
        parser.add_argument('--dino_sample', type=int,default=128)
